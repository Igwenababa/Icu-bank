    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Protect what matters most with our tailored insurance products.</p>
            </div>
            ...
            {isLoading ? (
                ...
                <div className="flex items-center space-x-3 text-yellow-700 bg-yellow-100 p-4 rounded-xl border border-yellow-200">
